...
with st.sidebar:
    ...
    # UPDATED: Only OpenAI and Google providers
    ...
    model_config = {
        "provider": provider,
        "cohere_api_key": "HR7VD787SvbNJsIeabrfqgDj2Bdxqwl551e8c2DN", 
        "tavily_api_key": "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"  
    }
    ...
    # UPDATED: Hardcoded supporting services configuration
    model_config["cohere_rerank_model"] = "rerank-english-v3.0"
...
keys_ready = model_config.get("api_key") and model_config.get("cohere_api_key")
        ...
        if not is_valid:
            ...
            if st.session_state.agent_executor:
                with st.chat_message("ai"):
                    with st.spinner("🤖 AI agent is analyzing documents..."):
                        try:
